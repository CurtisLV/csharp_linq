    ...
    public class Zip_Exercise2_Tests
    {
        ...
        public void GetDaysDifferencesBetweenDatesShallWorkCorrectly1()
        {
            ...
            Assert.AreEqual(
                expectedResult,
                result,
                $"For dates {EnumerableToString(dates)} the result shall be {EnumerableToString(expectedResult)} but it was '{EnumerableToString(result)}'"
            );
        }
