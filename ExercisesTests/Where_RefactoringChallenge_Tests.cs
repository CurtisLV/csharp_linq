    ...
    public class Where_RefactoringChallenge_Tests
    {
        ...
        public void GetMultipleFishOwnersShallWorkCorrectly()
        {
            ...
            var people = new[]
            {
                ...
                new Person(3, "Stephanie", new[] { pets.ElementAt(1), pets.ElementAt(3), })
            };
            ...
            CollectionAssert.AreEqual(
                expectedResult,
                result,
                $"Expected count of items: {expectedResult.Count()}, result count of items: {result.Count()}. Both John and Jack own multiple fish (John owns 2 fish, Jack owns 2 fish and a cat, Stephanie owns 1 fish and a dog)"
            );
        }
