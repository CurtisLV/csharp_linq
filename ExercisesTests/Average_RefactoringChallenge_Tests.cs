    ...
    public class Average_RefactoringChallenge_Tests
    {
        ...
        public void NullInput_Refactored()
        {
            ...
            Assert.AreEqual(
                0,
                result,
                $"For null input the result should be 0, but it was {result}"
            );
        }
        ...
        public void EmptyInput_Refactored()
        {
            ...
            Assert.AreEqual(
                0,
                result,
                $"For empty input the result should be 0, but it was {result}"
            );
        }
        ...
        {
            var result = Average.CalculateAverageHeight_Refactored(
                new List<float?> { null, 10 },
                0
            );
            Assert.AreEqual(
                5,
                result,
                $"For input (10, null) and default 0, the result should be 5, but it was {result}"
            );
        }
