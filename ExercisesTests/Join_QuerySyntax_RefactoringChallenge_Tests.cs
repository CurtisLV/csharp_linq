...
namespace ExercisesTests
{
    ...
    public class Join_QuerySyntax_RefactoringChallenge_Tests
    {
        ...
        public void GetSubjectsOfStudentsShallWorkCorrectly1()
        {
            ...
            var students = new HogwartsStudent[]
            {
                new HogwartsStudent
                {
                    HouseId = 4,
                    Name = "Draco",
                    SubjectsIds = new int[] { 1 }
                },
                new HogwartsStudent
                {
                    HouseId = 2,
                    Name = "Cedric",
                    SubjectsIds = new int[] { 2, 3 }
                },
                new HogwartsStudent
                {
                    HouseId = 3,
                    Name = "Luna",
                    SubjectsIds = new int[] { 1, 2, 3 }
                },
            };
        ...
        public void GetSubjectsOfStudentsShallWorkCorrectly1_Refactored()
        {
            ...
            var result = JoinQuerySyntax.GetSubjectsOfStudents_Refactored(
                students,
                subjects,
                houses
            );
