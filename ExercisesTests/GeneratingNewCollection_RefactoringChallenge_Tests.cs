    ...
    public class GeneratingNewCollection_RefactoringChallenge_Tests
    {
        ...
        public void NonEmpty()
        {
            ...
            CollectionAssert.AreEqual(
                expectedResult,
                result,
                $"For 3 first letters, the result shall be {EnumerableToString(expectedResult)} but it was {EnumerableToString(result)}"
            );
        }
        ...
        public void Empty()
        {
            ...
            CollectionAssert.AreEqual(
                expectedResult,
                result,
                $"For 0 first letters, the result shall be empty, but it was {EnumerableToString(result)}"
            );
        }
