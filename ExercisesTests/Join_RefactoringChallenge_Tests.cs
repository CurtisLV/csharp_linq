    ...
    public class Join_RefactoringChallenge_Tests
    {
        ...
        public void GetHousesDataShallWorkProperly1()
        {
            ...
            CollectionAssert.AreEquivalent(
                expectedResult,
                result,
                $"For PEOPLE {EnumerableToString(people)}, and HOUSES  {EnumerableToString(houses)}  the RESULT shall be {DictionaryToString(expectedResult)}, BUT IT WAS {DictionaryToString(result)}"
            );
        }
