    ...
    public class ConcatUnion_Exercise1_Tests
    {
        ...
        public void ShallSelectNewsProperly()
        {
            ...
            CollectionAssert.AreEqual(
                expectedResult,
                result,
                $"(See the exercise description for the input data) For input collection ({inputToString}) the result shall be ({expectedResultToString}) but it is ({resultToString})"
            );
        }
    }
}
