...
namespace ExercisesTests
{
    ...
    public class SelectMany_QuerySyntax_Exercise2_Tests
    {
        ...
        {
            var numbers1 = new[] { 1, 30, 42 };

            var numbers2 = new[] { 99, 82, 7 };
            ...
            var result = SelectManyQuerySyntax.SelectAllCombinationsWithSumBelow100(
                numbers1,
                numbers2
            );
        ...
        {
            var numbers1 = new[] { 1, 60 };

            var numbers2 = new[] { 98, 82, 7 };
