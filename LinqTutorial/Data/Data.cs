...
namespace LinqTutorial
{
    public static class Data
    {
        ...
        public static IEnumerable<VeterinaryClinicAppointment> VeterinaryClinicAppointments = new[]
        {
            new VeterinaryClinicAppointment(
                clinicId: 2,
                petId: 1,
            ...
            new VeterinaryClinicAppointment(
                clinicId: 3,
                petId: 3,
                new DateTime(2021, 10, 1, 12, 30, 0)
            ),
            new VeterinaryClinicAppointment(
                clinicId: 1,
                petId: 4,
        ...
        public static IEnumerable<PetOwner> People = new[]
        {
            ...
            new PetOwner(
                3,
                "Stephanie",
                new[] { Pets.ElementAt(3), Pets.ElementAt(4), Pets.ElementAt(5) }
            )
        };
    }
}
