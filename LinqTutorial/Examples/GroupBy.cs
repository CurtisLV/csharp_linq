...
namespace LinqTutorial.MethodSyntax
{
    static class GroupBy
    {
        ...
        public static void Run()
        {
            ...
            var petsGroupedByType = Data.Pets.GroupBy(pet => pet.PetType, pet => pet.Weight);
            ...
            var personInitialsPetsMapping = Data.People
                ...
                .ToDictionary(
                    ...
                    grouping =>
                        string.Join(
                            ", ",
                            grouping.SelectMany(person => person.Pets).Select(pet => pet.Name)
                        )
                );
            ...
            var weightGroups = Data.Pets
                .GroupBy(
                    ...
                    (floorOfWeight, allPetsInThisGroup) =>
                        new
                        {
        ...
        public static class QuerySyntax
        {
            ...
            public static void Run()
            {
                ...
                var petsGroupedByType = from pet in Data.Pets group pet by pet.PetType;
                ...
                var petsWeightsGroupsAsStrings =
                    from petWeightGroup in petWeightGroups
