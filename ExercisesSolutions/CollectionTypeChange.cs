...
namespace ExercisesSolutions
{
    public static class CollectionTypeChange
    {
            ...
            return words
                ...
                .ToDictionary(
                    ...
                    word =>
                    {
                        ...
                        return int.TryParse(word, out parsingResult) ? parsingResult : (int?)null;
                    }
                );
        }
        ...
        {
            return input.ToLookup(number => number % 2 == 0, number => number);
        }
        ...
        )
        {
            return students.ToDictionary(
                student =>
                    $"{student.FirstName} {student.LastName} born on"
